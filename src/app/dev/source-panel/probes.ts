...
export const PROBES: readonly ProbeDef[] = [
  ...
  },
  {
    ...
    host: "data.iana.org",
    wired: "diagnostic",
    note: "The RDAP bootstrap registry a W2 direct-registry path would consult. Not on the hot path today.",
  ...
  },
  {
    ...
    wired: "diagnostic",
    note: "The authoritative .com RDAP endpoint rdap.org redirects TO. Probed directly here for reachability; the product calls it only via rdap.org's redirect.",
    build: () => ({
  ...
  },
  {
    ...
    host: "rdap.org",
    wired: "wired",
    note: "The primary registration source (redirects to the authoritative registry; the harness follows the hop).",
