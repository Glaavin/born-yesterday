...
- `docs/PRODUCT.md` — (edited) → **v1.3** + changelog. B2B API dropped (§5–§7); revenue ad-or-tip, open, leaning tip; §4 AI-pivot corrected to shipped/deterministic (no LLM); §8 Risk 4 rewritten; §10 roadmap → epic convention; §12 SLA placeholder; §14 repo public + re-privatization (issue #6); §3/§16 → Story 18/19.
